    ...
    return (
        <div className=' h-screen bg-gray-200  flex  justify-center items-center'>
            <div className='h-auto w-1/4 bg-white shadow-2xl rounded-lg p-6 flex flex-col gap-2'>
                ...
                {
                    status ? <div className='flex justify-center bg-white py-1 my-2'><span className="loading loading-dots loading-md text-green-400 "></span></div> : <button className=' bg-green-600 text-white py-1 my-2 rounded-lg' onClick={handleSignup}>Signup</button>
                }
